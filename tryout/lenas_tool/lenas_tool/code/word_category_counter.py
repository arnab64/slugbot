...
def default_dictionary_filename():
    return os.path.abspath(os.path.join(os.path.dirname(__file__), '../lexicons/LIWC2015_English_Flat.dic'))
...
class Dictionary():
    ...
    _liwc_categories = [
        ...
        ('Conjunctions', 14, 'conj', None, None),
        ('Informal', 120, 'informal', None, None),
